...
const AllAvatars = [_]u32{
    ...
    1314, 1315, 1317, 1221, 1218, 1224, 8002,
};
...
pub fn onGetMultiPathAvatarInfo(session: *Session, _: *const Packet, allocator: Allocator) !void {
    ...
    try rsp.current_multi_avatar_id.append(.{ .key = 1001, .value = .Mar_7thRogueType });
    try rsp.current_multi_avatar_id.append(.{ .key = 8001, .value = .BoyWarriorType });
